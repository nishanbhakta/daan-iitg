        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-12 rounded-3xl border border-cyan-400/20 bg-white/5 p-6 text-center backdrop-blur-md">
            ...
            <p className="text-gray-300 leading-7">
              Don’t hesitate to reach out with questions about IIT Guwahati,
              admission formalities, hostel life, academics, campus facilities,
              or student life. We are happy to guide and support incoming
              freshers.
            </p>
          </div>
        </div>
